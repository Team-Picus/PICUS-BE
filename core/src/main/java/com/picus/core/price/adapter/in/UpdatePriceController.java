...
import com.picus.core.price.adapter.in.web.data.request.UpdatePriceListRequest;
...
public class UpdatePriceController {
    ...
    @PatchMapping
    public BaseResponse<Void> applyPriceChanges(@RequestBody @Valid UpdatePriceListRequest webRequest,
