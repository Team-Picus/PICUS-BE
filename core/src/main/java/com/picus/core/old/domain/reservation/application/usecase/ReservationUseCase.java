package com.picus.core.old.domain.reservation.application.usecase;

import com.picus.core.old.domain.post.application.dto.response.PostDetailResponse;
import com.picus.core.old.domain.post.application.usecase.PostManagementUseCase;
import com.picus.core.old.domain.reservation.application.dto.request.ReservationRequestDto;
import com.picus.core.old.domain.reservation.application.dto.request.SelectedAdditionalOptionRequest;
import com.picus.core.old.domain.reservation.domain.entity.Reservation;
import com.picus.core.old.domain.reservation.domain.service.ReservationService;
