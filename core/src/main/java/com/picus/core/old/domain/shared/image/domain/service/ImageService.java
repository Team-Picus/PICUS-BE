package com.picus.core.old.domain.shared.image.domain.service;

import com.picus.core.old.domain.shared.image.application.dto.request.UploadImage;
import com.picus.core.old.domain.shared.image.domain.repository.ImageRepository;
import com.picus.core.old.domain.shared.image.domain.repository.MessageImageResourceRepository;
import com.picus.core.old.domain.shared.image.domain.repository.PostImageResourceRepository;
import com.picus.core.old.domain.shared.image.domain.repository.ReviewImageResourceRepository;
...
import com.picus.core.old.domain.shared.image.domain.factory.ImageFactory;
    ...
    public Image findImage(Long imageId, ImageType imageType) {
        return switch (imageType) {
            ...
            case REVIEW -> reviewImageResourceRepository.findById(imageId)
                    .orElseThrow(() -> new RestApiException(GlobalErrorStatus._NOT_FOUND));
            case null -> throw new RestApiException(GlobalErrorStatus._METHOD_ARGUMENT_ERROR);
        };
    }
}
