...
package com.picus.core.global.utils;
...
public class StompHeaderAccessorUtil {
    ...
    public Long getUserNoInSession(StompHeaderAccessor accessor) {
    ...
    public Long getChatRoomNoInSession(StompHeaderAccessor accessor) {
