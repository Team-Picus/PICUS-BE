...
class UpdatePostControllerTest extends AbstractSecurityMockSetup {
    ...
    public void updatePost_success() throws Exception {
        ...
        UpdatePostRequest webReq = createUpdatePostWebReq(List.of(
                ...
                List.of(PostThemeType.BEAUTY, PostThemeType.EVENT), List.of(),
    ...
    public void updatePost_fail2() throws Exception {
        // given
        UpdatePostRequest webReq = createUpdatePostWebReq(List.of(), "테스트 제목", "한 줄 설명", "자세한 설명입니다.",
                List.of(PostThemeType.BEAUTY, PostThemeType.EVENT), List.of(),
                List.of(PostMoodType.COZY), SpaceType.INDOOR, "서울시 강남구", "pkg-001");
    ...
    private UpdatePostRequest createUpdatePostWebReq(List<UpdatePostRequest.PostImageRequest> postImages, String title,
                                                     ...
                                                     List<PostMoodType> postMoodTypes, SpaceType spaceType, String spaceAddress, String packageNo) {
