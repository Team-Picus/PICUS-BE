...
class CreatePostWebMapperTest {
    ...
    public void toCommand() throws Exception {
        ...
        CreatePostRequest webReq = CreatePostRequest.builder()
                ...
                .packages(List.of(
                        CreatePostRequest.PackageRequest.builder()
                                .packageNo("pkg-001")
        ...
        assertThat(appReq.packages()).hasSize(1)
                .extracting(
                        CreatePostCommand.PackageCommand::packageNo,
                        CreatePostCommand.PackageCommand::packageThemeType,
                        CreatePostCommand.PackageCommand::snapSubTheme
                ).containsExactlyInAnyOrder(
