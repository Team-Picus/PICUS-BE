...
class WritePostWebMapperTest {

    private final WritePostWebMapper webMapper = new WritePostWebMapper();

    @Test
    @DisplayName("WritePostWebReq -> WritePostAppReq 매핑")
    public void toAppReq() throws Exception {
        // given
        WritePostWebReq webReq = WritePostWebReq.builder()
                .postImages(List.of(
        ...
        // when
        WritePostAppReq appReq = webMapper.toAppReq(webReq, currentUserNo);
