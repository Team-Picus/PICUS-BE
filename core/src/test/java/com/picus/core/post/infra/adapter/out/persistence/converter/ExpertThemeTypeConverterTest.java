...
import com.picus.core.post.domain.model.vo.ThemeType;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;

import java.util.List;

import static com.picus.core.post.domain.model.vo.ThemeType.*;
import static org.assertj.core.api.Assertions.assertThat;
import static org.junit.jupiter.api.Assertions.*;

class ExpertThemeTypeConverterTest {

    @Test
    @DisplayName("ExpertThemeType 리스트를 ,를 기준으로 하나의 문자열로 이어붙인다.")
    public void convertToDatabaseColumn() throws Exception {
        // given
        ThemeTypeConverter themeTypeConverter = new ThemeTypeConverter();
        List<ThemeType> themeTypes = List.of(FASHION, BEAUTY, EVENT);

        // when
        themeTypeConverter.convertToDatabaseColumn(themeTypes);
